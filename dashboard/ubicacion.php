...
<h2 style="color: white; font-family: Arial; text-align: center;">Buscar Ubicación de un Producto</h2>
<h4 style="color: white; font-family: Arial;">Ingrese el ID del producto a buscar:</h4>
	   ...
	   <button class="btn btn-dark my-2 my-sm-0" id="ubicacion" >Buscar</button>
</div>
<div class="limiter">
	...
	<script src="js/cargarUbicacion.js"></script>
